open Prims
type aux_vecexport = Wasm_Parse_Export.export Prims.list



let (aux_vecexport_parser32 :
  LowParse_SLow_Base.bytes32 ->
    (aux_vecexport * FStar_UInt32.t) FStar_Pervasives_Native.option)
  =
  fun input ->
                                  ...
                                  (match x with
                                   | FStar_Pervasives_Native.Some
                                       ...
                                       then (false, x)
                                         ...
                                         (match Wasm_Parse_Export.export_parser32
                                                  input'1
                                          with
...
let (aux_vecexport_serializer32 :
  aux_vecexport -> LowParse_SLow_Base.bytes32) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Export.export_serializer32 a in
...
let (aux_vecexport_size32 : aux_vecexport -> FStar_UInt32.t) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Export.export_size32 a in
