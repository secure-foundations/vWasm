open Prims
type aux_vecdata = Wasm_Parse_Data.data Prims.list



let (aux_vecdata_parser32 :
  LowParse_SLow_Base.bytes32 ->
    (aux_vecdata * FStar_UInt32.t) FStar_Pervasives_Native.option)
  =
  fun input ->
    ...
    | FStar_Pervasives_Native.Some (v, l) ->
        ...
        (match match let res =
                                  ...
                                  (match x with
                                   | FStar_Pervasives_Native.Some
                                       ...
                                       then (false, x)
                                         ...
                                         (match Wasm_Parse_Data.data_parser32
                                                  input'1
                                          with
         ...
         | uu___ -> FStar_Pervasives_Native.None)
    | uu___ -> FStar_Pervasives_Native.None
let (aux_vecdata_serializer32 : aux_vecdata -> LowParse_SLow_Base.bytes32) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Data.data_serializer32 a in
...
let (aux_vecdata_size32 : aux_vecdata -> FStar_UInt32.t) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Data.data_size32 a in
