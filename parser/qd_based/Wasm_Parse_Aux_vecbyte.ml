open Prims
type aux_vecbyte = FStar_UInt8.t Prims.list



let (aux_vecbyte_parser32 :
  LowParse_SLow_Base.bytes32 ->
    (aux_vecbyte * FStar_UInt32.t) FStar_Pervasives_Native.option)
  =
  fun input ->
    ...
    | FStar_Pervasives_Native.Some (v, l) ->
        ...
        (match match let res =
                                  ...
                                  (match x with
                                   | FStar_Pervasives_Native.Some
                                       ...
                                       then (false, x)
                                         ...
                                         (match LowParse_SLow_Int.parse32_u8
                                                  input'1
                                          with
         ...
         | uu___ -> FStar_Pervasives_Native.None)
    | uu___ -> FStar_Pervasives_Native.None
let (aux_vecbyte_serializer32 : aux_vecbyte -> LowParse_SLow_Base.bytes32) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = LowParse_SLow_Int.serialize32_u8 a in
...
let (aux_vecbyte_size32 : aux_vecbyte -> FStar_UInt32.t) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = FStar_UInt32.uint_to_t Prims.int_one in
