open Prims
type aux_vectypeidx = Wasm_Parse_Typeidx.typeidx Prims.list



let (aux_vectypeidx_parser32 :
  LowParse_SLow_Base.bytes32 ->
    (aux_vectypeidx * FStar_UInt32.t) FStar_Pervasives_Native.option)
  =
  fun input ->
                    ...
                    if
                      Prims.op_Negation
                        ((FStar_UInt32.lt v
                           ...
                           ||
                           (FStar_UInt32.lt
                              (FStar_UInt32.uint_to_t (Prims.of_int (2047)))
                              v))
                                  ...
                                  (match x with
                                   | FStar_Pervasives_Native.Some
                                       ...
                                       then (false, x)
                                         ...
                                         (match Wasm_Parse_Typeidx.typeidx_parser32
                                                  input'1
                                          with
...
let (aux_vectypeidx_serializer32 :
  aux_vectypeidx -> LowParse_SLow_Base.bytes32) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Typeidx.typeidx_serializer32 a in
...
let (aux_vectypeidx_size32 : aux_vectypeidx -> FStar_UInt32.t) =
  fun x ->
    let ln =
      match let uu___ =
              C_Loops.total_while_gen () ()
            ...
            (fun uu___1 ->
               ...
               | (uu___2, x2) ->
                   (match x2 with
                    | ([], res) -> (false, x2)
                    | (a::q, res) ->
                        let sa = Wasm_Parse_Typeidx.typeidx_size32 a in
