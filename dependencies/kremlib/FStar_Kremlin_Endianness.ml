open Prims
let rec (le_to_n : FStar_UInt8.t FStar_Seq_Base.seq -> Prims.nat) =
  fun b ->
...
let rec (be_to_n : FStar_UInt8.t FStar_Seq_Base.seq -> Prims.nat) =
  fun b ->
    if (FStar_Seq_Base.length b) = Prims.int_zero
    then Prims.int_zero
    else
  ...
  fun len ->
    fun n ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let len1 =
           FStar_UInt32.sub len (FStar_UInt32.uint_to_t Prims.int_one) in
...
let (uint32_of_le : FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt32.t) =
  fun b -> let n = le_to_n b in FStar_UInt32.uint_to_t n
let (le_of_uint32 : FStar_UInt32.t -> FStar_UInt8.t FStar_Seq_Base.seq) =
  fun x ->
    n_to_le (FStar_UInt32.uint_to_t (Prims.of_int (4))) (FStar_UInt32.v x)
let (uint32_of_be : FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt32.t) =
  fun b -> let n = be_to_n b in FStar_UInt32.uint_to_t n
let (be_of_uint32 : FStar_UInt32.t -> FStar_UInt8.t FStar_Seq_Base.seq) =
  fun x ->
    n_to_be (FStar_UInt32.uint_to_t (Prims.of_int (4))) (FStar_UInt32.v x)
let (uint64_of_le : FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt64.t) =
  fun b -> let n = le_to_n b in FStar_UInt64.uint_to_t n
let (le_of_uint64 : FStar_UInt64.t -> FStar_UInt8.t FStar_Seq_Base.seq) =
  fun x ->
    n_to_le (FStar_UInt32.uint_to_t (Prims.of_int (8))) (FStar_UInt64.v x)
let (uint64_of_be : FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt64.t) =
  fun b -> let n = be_to_n b in FStar_UInt64.uint_to_t n
let (be_of_uint64 : FStar_UInt64.t -> FStar_UInt8.t FStar_Seq_Base.seq) =
  fun x ->
    n_to_be (FStar_UInt32.uint_to_t (Prims.of_int (8))) (FStar_UInt64.v x)
let rec (seq_uint32_of_le :
  Prims.nat ->
    FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt32.t FStar_Seq_Base.seq)
  =
  fun l ->
    fun b ->
      if (FStar_Seq_Base.length b) = Prims.int_zero
...
let rec (seq_uint64_of_le :
  Prims.nat ->
    FStar_UInt8.t FStar_Seq_Base.seq -> FStar_UInt64.t FStar_Seq_Base.seq)
  =
  fun l ->
    fun b ->
      if (FStar_Seq_Base.length b) = Prims.int_zero
